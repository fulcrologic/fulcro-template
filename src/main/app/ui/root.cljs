  ...
  (div :.ui.segments
    (div :.ui.top.attached.segment
      ...
      (p
        ...
        add some, be sure to reload the page and see it come back. Note there is a built-in network delay so you
        can see the difference between an optimistic update (the added user ID) and one from the network (the address
        response from the server add)")
      (p
